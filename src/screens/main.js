...
export default class Main extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedMovie: {
        ...
        type: "Cillian",
        imageUrl:
          "https://m.media-amazon.com/images/M/MV5BMjUxMDEzNTYyN15BMl5BanBnXkFtZTgwMjQyMzg1NzM@._V1_UY268_CR16,0,182,268_AL_.jpg ",
      },
      movieDetail: "fain",
  ...
  getMoviesFromIMDB = (title) => {
    ...
    axios
      ...
      .then((response) =>
        this.setState({
          movies: this.formatIMDBArrayResponse(response.data.results),
        })
      )
      .catch((error) => {
        this.setState({
  ...
  getRelated = (movieId) => {
    ...
    axios
      ...
      .then(async (response) => {
        ...
        const formatedRaletedMovied = this.formatIMDBArrayResponse(
